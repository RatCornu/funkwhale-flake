  ...
  outputs = { self, nixpkgs }:
    ...
    in
    {
      overlays.default = final: prev: {
        ...
        requests-http-message-signatures = with final; with pkgs.python310.pkgs; (buildPythonPackage rec {
        ...
        django-cache-memoize = with final; with pkgs.python310.pkgs; (buildPythonPackage rec {
        ...
        django-versatileimagefield = with final; with pkgs.python310.pkgs; (buildPythonPackage rec {
        ...
        # ------------- will be in 23.11
        jsonschema-specifications = with final; with pkgs.python310.pkgs; (buildPythonPackage rec {
        ...
        referencing = with final; with pkgs.python310.pkgs; (buildPythonPackage rec {
          pname = "referencing";
          version = "0.30.0";
          format = "pyproject";
        ...
        rpds-py = with final; with pkgs.python310.pkgs; (buildPythonPackage rec {
          pname = "rpds-py";
          version = "0.9.2";
          format = "pyproject";
